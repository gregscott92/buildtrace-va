...
app.post("/login", async (req, res) => {
  try {
    ...
    console.log("LOGIN SUPABASE RESULT:", {
      hasData: !!data,
    ...
    if (error) {
      return res.status(400).json({
        error: error.message,
        route: "/login",
        source: "supabaseAuth.signInWithPassword"
      });
    }
...
app.post("/signup", async (req, res) => {
  try {
    ...
    console.log("SIGNUP HEADERS:", JSON.stringify(req.headers, null, 2));
    console.log("SIGNUP BODY RAW:", req.body);
    ...
    console.log("SIGNUP SUPABASE RESULT:", {
      hasData: !!data,
      error: error ? error.message : null
    });
