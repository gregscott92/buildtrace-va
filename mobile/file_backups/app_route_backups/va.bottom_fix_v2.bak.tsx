      ...
      {result ? (
        ...
        >
          ...
          <Text style={{ fontSize: 16, marginBottom: 8 }}>
            ...
            {result?.structured?.diagnosticCode || parsed.diagnosticCode || "N/A"}
          </Text>
          ...
          <Text style={{ fontSize: 16, marginBottom: 12 }}>
            <Text style={{ fontWeight: "700" }}>Confidence: 
<Text style={{ color: confidenceColor, fontWeight: "700" }}>
  {structured?.confidence || "N/A"}
</Text>
            {result?.structured?.confidence || parsed.confidence || "N/A"}
          </Text>
          ...
          {reasoningItems.length ? (
            ...
            <Text style={{ fontSize: 15, marginBottom: 12 }}>
              {result?.structured?.reasoning || parsed.reasoning || "N/A"}
            </Text>
          )}
          ...
          {evidenceItems.length ? (
            ...
            <Text style={{ fontSize: 15, marginBottom: 12 }}>
              {result?.structured?.evidenceNeeded || parsed.evidenceNeeded || "N/A"}
            </Text>
          )}
          ...
          {nextStepItems.length ? (
            ...
            <Text style={{ fontSize: 15, marginBottom: 12 }}>
              {result?.structured?.nextSteps || parsed.nextSteps || "N/A"}
            </Text>
          )}
          ...
          {importantItems.length ? (
            ...
            <Text style={{ fontSize: 15, marginBottom: 12 }}>
              {result?.structured?.important || parsed.important || "N/A"}
            </Text>
          )}
