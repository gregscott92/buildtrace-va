...
function extractSection(text, label) {
  try {
    ...
    console.log("extractSection error:", err.message);
    return null;
  }
}
...
app.post("/va/analyze", upload.single("image"), async (req, res) => {
  try {
    ...
    const structured = {
      condition: extractSection(result, "Condition") || "N/A",
      diagnosticCode: extractSection(result, "Diagnostic Code") || "N/A",
      estimatedRating: extractSection(result, "Estimated VA Rating") || "N/A",
      confidence: extractSection(result, "Confidence") || "N/A",
      reasoning: extractSection(result, "Reasoning") || "N/A",
      evidenceNeeded: extractSection(result, "Evidence Still Needed") || "N/A",
      nextSteps: extractSection(result, "Next Steps") || "N/A",
      important: extractSection(result, "Important") || "N/A"
