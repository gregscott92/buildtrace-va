...
");
    ...
    const structured = {
      condition:
        extractSection(result, "Condition") ||
        (result.includes("Condition:")
...
")[0]?.trim()
      ...
      diagnosticCode:
        extractSection(result, "Diagnostic Code") ||
        (result.includes("Diagnostic Code:")
...
")[0]?.trim()
      ...
      estimatedRating:
        extractSection(result, "Estimated VA Rating") ||
        (result.includes("Estimated VA Rating:")
...
")[0]?.trim()
      ...
      confidence:
        extractSection(result, "Confidence") ||
...
")[0]?.trim()
      ...
      reasoning:
        extractSection(result, "Reasoning") || "N/A",

      evidenceNeeded:
        extractSection(result, "Evidence Still Needed") || "N/A",

      nextSteps:
        extractSection(result, "Next Steps") || "N/A",

      important:
        extractSection(result, "Important") || "N/A"
    };

    return res.json({
      success: true,
      likelihood: structured.estimatedRating || "See analysis",
      summary: result,
      structured,
      visionExtract,
      disclaimer:
